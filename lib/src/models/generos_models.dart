...
class GenerosModels {
  ...
  factory GenerosModels.fromRawJson(String str) =>
      GenerosModels.fromJson(json.decode(str));

  factory GenerosModels.fromJson(Map<String, dynamic> json) => GenerosModels(
        adult: json["adult"],
